...
## Inspecting for Categorical Variables

```{r, message=TRUE, ca}
str(df_crime_train)
```
## Contingecny Tables / Frequency
...
Visually it is apparent that not all the data is normalized.
To assist with interpreting, attributes are re scaled to
