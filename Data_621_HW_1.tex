...
To determine how to handle missing variables, we created four different
datasets. We imputed missing values with the mean, median, and zero, and
also removed the missing values altogether.

Afterwards, we constructed linear models using these four datasets to
determine which model had the best adjusted R-squared value.

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Fit a multiple linear regression model using lm with variables imputed:mean}
\NormalTok{model\_mn }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(TARGET\_WINS }\SpecialCharTok{\textasciitilde{}}\NormalTok{ ., }\AttributeTok{data =}\NormalTok{ df\_train\_mn)}

\CommentTok{\# Summary of the regression model}
\FunctionTok{summary}\NormalTok{(model\_mn)}\SpecialCharTok{$}\NormalTok{adj.r.squared}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Fit a multiple linear regression model using lm with variables imputed:median}
\NormalTok{model\_md }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(TARGET\_WINS }\SpecialCharTok{\textasciitilde{}}\NormalTok{ ., }\AttributeTok{data =}\NormalTok{ df\_train\_md)}

\CommentTok{\# Summary of the regression model}
\FunctionTok{summary}\NormalTok{(model\_md)}\SpecialCharTok{$}\NormalTok{adj.r.squared}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Fit a multiple linear regression model using lm with variables imputed:zero}
\NormalTok{model\_0 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(TARGET\_WINS }\SpecialCharTok{\textasciitilde{}}\NormalTok{ ., }\AttributeTok{data =}\NormalTok{ df\_train\_0)}

\CommentTok{\# Summary of the regression model}
\FunctionTok{summary}\NormalTok{(model\_0)}\SpecialCharTok{$}\NormalTok{adj.r.squared}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Fit a multiple linear regression model using lm with variables: removed}
\NormalTok{model\_rm }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(TARGET\_WINS }\SpecialCharTok{\textasciitilde{}}\NormalTok{ ., }\AttributeTok{data =}\NormalTok{ df\_train\_rm)}

\CommentTok{\# Summary of the regression model}
\FunctionTok{summary}\NormalTok{(model\_rm)}\SpecialCharTok{$}\NormalTok{adj.r.squared}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{Data_621_HW_1_files/figure-latex/unnamed-chunk-30-1.pdf}
...
\begin{Highlighting}[]
\CommentTok{\# Fit a multiple linear regression model using lm with variables: removed}
\NormalTok{model\_combo }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(TARGET\_WINS }\SpecialCharTok{\textasciitilde{}}\NormalTok{ ., }\AttributeTok{data =}\NormalTok{ df\_train\_with\_combo)}

\CommentTok{\# Summary of the regression model}
\FunctionTok{summary}\NormalTok{(model\_combo)}\SpecialCharTok{$}\NormalTok{adj.r.squared}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{Data_621_HW_1_files/figure-latex/unnamed-chunk-33-1.pdf}
