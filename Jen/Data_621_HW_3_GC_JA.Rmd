...
df_scaled_classification$PREDICTION = predict(A6_back_elim, new = df_scaled_classification)
```
...
```{r}
df_scaled_eval$PREDICTION = predict(A6_back_elim, new = df_scaled_eval)
```
