...
```{r}
# Replace NA values in 'column_name' with 'means'
df_train <- df_train %>%
...
**Note:**
          ...
          While deciding on whether to use 'Mean' or 'Media' both 
          codes were generated. Unutilized code, whether Mead or Median
          replacement is left commented out, since it will not be used.
