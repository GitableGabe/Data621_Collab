...
```{r, echo=FALSE}
'column1'<-c("INDEX", "TARGET_FLAG", "TARGET_AMT", "AGE", "BLUEBOOK", "CAR_AGE",
...
'column2'<- c("Identification Variable (do not use)",
...
my_data_frame <- data.frame(column1 = column1,
                            Definition = column2,
                            column3 = column3)%>%
