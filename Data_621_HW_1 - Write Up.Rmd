...
df_train <-
  rename(df_train, "BATTING_HITS"="TEAM_BATTING_H", "BATTING_2B"="TEAM_BATTING_2B",
         "BATTING_3B"="TEAM_BATTING_3B", "BATTING_HR"="TEAM_BATTING_HR", "BATTING_BB"="TEAM_BATTING_BB",
         "BASERUN_SB"="TEAM_BASERUN_SB", "BASERUN_CS"="TEAM_BASERUN_CS", "BATTING_HBP"="TEAM_BATTING_HBP",
         "PITCHING_HITS"="TEAM_PITCHING_H", "PITCHING_HR"="TEAM_PITCHING_HR", "PITCHING_BB"="TEAM_PITCHING_BB",
         "FIELD_ERRORS"="TEAM_FIELDING_E", "FIELD_DBLPLY"="TEAM_FIELDING_DP","BATTING_SO"="TEAM_BATTING_SO",
         "PITCHING_SO"="TEAM_PITCHING_SO")
df_evaluation <-
  rename(df_evaluation, "BATTING_HITS"="TEAM_BATTING_H", "BATTING_2B"="TEAM_BATTING_2B",
         "BATTING_3B"="TEAM_BATTING_3B", "BATTING_HR"="TEAM_BATTING_HR", "BATTING_BB"="TEAM_BATTING_BB",
         "BASERUN_SB"="TEAM_BASERUN_SB", "BASERUN_CS"="TEAM_BASERUN_CS", "BATTING_HBP"="TEAM_BATTING_HBP",
         "PITCHING_HITS"="TEAM_PITCHING_H", "PITCHING_HR"="TEAM_PITCHING_HR", "PITCHING_BB"="TEAM_PITCHING_BB",
         "FIELD_ERRORS"="TEAM_FIELDING_E", "FIELD_DBLPLY"="TEAM_FIELDING_DP","BATTING_SO"="TEAM_BATTING_SO",
...
```{r}
df_train %>% 
  gather(variable, value, TARGET_WINS: FIELD_DBLPLY)%>% #pivot longer to plot all variables
...
df_train %>%
  gather(variable, value, BATTING_HITS: FIELD_DBLPLY)%>% #pivot longer to plot all variables
...
model_mn <- lm(TARGET_WINS ~ BATTING_HITS+BATTING_2B+BATTING_3B+BATTING_HR+BATTING_BB+BATTING_SO+BASERUN_SB+
                 BASERUN_CS+BATTING_HBP+PITCHING_HITS+PITCHING_HR+PITCHING_BB+PITCHING_SO+FIELD_ERRORS+FIELD_DBLPLY,
               data = df_train_mn)
...
model_md <- lm(TARGET_WINS ~ BATTING_HITS+BATTING_2B+BATTING_3B+BATTING_HR+BATTING_BB+BATTING_SO+BASERUN_SB+
                 BASERUN_CS+BATTING_HBP+PITCHING_HITS+PITCHING_HR+PITCHING_BB+PITCHING_SO+FIELD_ERRORS+FIELD_DBLPLY,
               data = df_train_md)
...
df_train_0 <- df_train %>%
  replace_na( list( INDEX = 0,    TARGET_WINS = 0,    BATTING_HITS = 0,    BATTING_2B = 0,
    ...
    BASERUN_CS = 0,    BATTING_HBP = 0,    PITCHING_HITS = 0,    PITCHING_HR = 0,    PITCHING_BB = 0,
    PITCHING_SO = 0,    FIELD_ERRORS = 0,    FIELD_DBLPLY = 0  ))
```
...
model_0 <- lm(TARGET_WINS ~ BATTING_HITS+BATTING_2B+BATTING_3B+BATTING_HR+BATTING_BB+BATTING_SO+BASERUN_SB+
                 BASERUN_CS+BATTING_HBP+PITCHING_HITS+PITCHING_HR+PITCHING_BB+PITCHING_SO+FIELD_ERRORS+FIELD_DBLPLY,
              data = df_train_0)
...
model_rm <- lm(TARGET_WINS ~ BATTING_HITS+BATTING_2B+BATTING_3B+BATTING_HR+BATTING_BB+BATTING_SO+BASERUN_SB+
                 BASERUN_CS+BATTING_HBP+PITCHING_HITS+PITCHING_HR+PITCHING_BB+PITCHING_SO+FIELD_ERRORS+FIELD_DBLPLY,
               data = df_train_rm)
...
```{r}
# How many values are missing from BATTING_HBP in the evaluation dataset that we will need to use our regression model to predict wins for?
...
```{r}
df_train_ratio %>% 
  gather(variable, value, TARGET_WINS: TARGET_WINS_RATIO)%>% #pivot longer to plot all variables
  ggplot(.,aes(x=value)) + #plotting every variable
...
```{r}
model_initial <- lm(TARGET_WINS ~ BATTING_HITS+BATTING_2B +BATTING_3B+BATTING_HR+BATTING_BB+BATTING_SO+
BASERUN_SB+ BASERUN_CS + BATTING_HBP +PITCHING_HITS+ PITCHING_HR+PITCHING_BB+PITCHING_SO+FIELD_ERRORS+ FIELD_DBLPLY, data = df_train)
...
* A - Mean Imputation & Combining Variables
* B - Mean Imputation & Square Root Transformed Variables
* C - Zero Imputation & Ratio Transformed Variables
...
model_mn_2 <- lm(TARGET_WINS ~ BATTING_HITS+BATTING_2B+BATTING_BB+BATTING_SO+
                 BASERUN_SB+BASERUN_CS+FIELD_ERRORS+PITCHING_HR+BATTING_3B+BATTING_HR
##               +BATTING_HBP
...
df_train_with_combo <- df_train_mn %>%
  ...
  select(-BATTING_HITS, -PITCHING_HITS, -BATTING_HR, -PITCHING_HR, -BATTING_BB,-PITCHING_BB,
         -BATTING_SO,-BATTING_HBP,- PITCHING_SO)
...
```{r}
model_mn_5_combo <- lm(TARGET_WINS ~ team_H + team_BB + FIELD_ERRORS +FIELD_DBLPLY+ team_SO+ team_HR
            ##+ BATTING_HBP
...
```{r}
# Fit a multiple linear regression model using lm with square root transformed variables
model_sqrt_1 <- lm(TARGET_WINS ~ BATTING_HITS+BATTING_2B+BATTING_3B+BATTING_HR+BATTING_BB+BATTING_SO+BASERUN_SB+
                 BASERUN_CS+BATTING_HBP+PITCHING_HITS+PITCHING_HR+PITCHING_BB+PITCHING_SO+FIELD_ERRORS+FIELD_DBLPLY,
               data = df_train_sqrt)
...
```{r}
model_sqrt_2 <- lm(TARGET_WINS ~ BATTING_HITS+BATTING_2B+BATTING_3B+BATTING_HR+BATTING_BB+BATTING_SO+BASERUN_SB+
                 ##BASERUN_CS + BATTING_HBP
...
```{r}
model_sqrt_3 <- lm(TARGET_WINS ~ BATTING_HITS+BATTING_2B+BATTING_3B+BATTING_SO+BASERUN_SB+
                 ##BASERUN_CS + BATTING_HBP
                 +PITCHING_HITS
...
```{r}
model_sqrt_4 <- lm(TARGET_WINS ~ BATTING_HITS+BATTING_2B+BATTING_3B+BATTING_SO+BASERUN_SB+
                 ##BASERUN_CS 
...
## C - **Zero Imputation & Ratio Transformed Variables**
### C1 - **ALL Variables -Adj.R .232**


```{r}
# Fit a multiple linear regression model
model_ratio_1 <- lm(TARGET_WINS_RATIO ~ BATTING_HITS+BATTING_2B+BATTING_3B+BATTING_HR+BATTING_BB+BATTING_SO+BASERUN_SB+
                 BASERUN_CS+BATTING_HBP+PITCHING_HITS+PITCHING_HR+PITCHING_BB+PITCHING_SO+FIELD_ERRORS+FIELD_DBLPLY,
               data = df_train_ratio)
...
model_ratio_2 <- lm(TARGET_WINS_RATIO ~ BATTING_HITS+BATTING_2B+BATTING_3B
                    ...
                    +BASERUN_CS+BATTING_HBP+PITCHING_HITS+PITCHING_HR+PITCHING_BB+PITCHING_SO+FIELD_ERRORS,
               data = df_train_ratio)
...
model_ratio_3 <- lm(TARGET_WINS_RATIO ~ BATTING_HITS+BATTING_2B+BATTING_3B
                    ...
                    +BATTING_BB+BATTING_SO+BASERUN_SB
                    +BASERUN_CS+PITCHING_HITS+PITCHING_HR+PITCHING_BB+PITCHING_SO+FIELD_ERRORS,
               data = df_train_ratio)
...
### **Observations**
* Mean squared Error:
* Adjusted R-squared is .320 indicating the model accounts for 32% of the variability in our training dataset
* F-statistics:
* Residual Plots:
...
df_evaluation$TARGET_WINS = df_evaluation$BATTING_HITS * df_coeff$BATTING_HITS
+ df_evaluation$BATTING_2B * df_coeff$BATTING_2B
+ df_evaluation$BATTING_3B * df_coeff$BATTING_3B
+ df_evaluation$BATTING_SO * df_coeff$BATTING_SO
+ df_evaluation$BASERUN_SB * df_coeff$BASERUN_SB
+ df_evaluation$BATTING_HBP * df_coeff$BATTING_HBP
+ df_evaluation$PITCHING_HITS * df_coeff$PITCHING_HITS
+ df_evaluation$PITCHING_SO * df_coeff$PITCHING_SO
+ df_evaluation$FIELD_ERRORS * df_coeff$FIELD_ERRORS
 + df_coeff$Intercept
